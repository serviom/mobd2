...
use Lezgro\Mobd2Bundle\Form\UsersType;
...
class UsersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LezgroMobd2Bundle:Users')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LezgroMobd2Bundle:Users')->find($id);
     ...
     * @Method("POST")
     * @Template("LezgroMobd2Bundle:Users:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("LezgroMobd2Bundle:Users:edit.html.twig")
     */

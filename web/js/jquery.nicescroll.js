...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        cursor.css({
          position:"relative","cursor":"pointer",top:0,"float":"right",width:self.opt.cursorwidth,height:"0px",
        ...
        if (self.opt.boxzoom&&!self.ispage&&!cap.isieold) {
          ...
          self.zoom = $(zoom);
          self.zoom.css({"cursor":"pointer",'z-index':self.opt.zindex,'height':18,'width':18,'backgroundPosition':'0px 0px'});
